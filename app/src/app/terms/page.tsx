    ...
    <main className="min-h-screen bg-[#010828] px-4 py-24 text-[#EFF4FF] sm:px-6 lg:px-16">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 space-y-8 font-mono text-[14px] leading-relaxed text-[#EFF4FF]/80 sm:text-[15px]">
          <section>
            <h2 className="font-grotesk text-xl uppercase text-[#EFF4FF] mb-4">Use of Strand</h2>
            <p>
          ...
          <section>
            <h2 className="font-grotesk text-xl uppercase text-[#EFF4FF] mb-4">Wallets and accounts</h2>
            <p>
          ...
          <section>
            <h2 className="font-grotesk text-xl uppercase text-[#EFF4FF] mb-4">Work records</h2>
            <p>
          ...
          <section>
            <h2 className="font-grotesk text-xl uppercase text-[#EFF4FF] mb-4">Credit</h2>
            <p>
          ...
          <section>
            <h2 className="font-grotesk text-xl uppercase text-[#EFF4FF] mb-4">No guarantees</h2>
            <p>
